...
export const issueReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.ASSIGNED_ISSUE_TO_USER_SUCCESS : //update issue 1h21min
        ...
        case actionTypes.DELETE_ISSUE_SUCCESS:
            return { ...state, loading: false, issues: state.issues.filter((issue) =>
            issue.id !== action.issueId) };

        case actionTypes.FETCH_ISSUES_FAILURE:
        case actionTypes.CREATE_ISSUE_FAILURE:
        //case actionTypes.UPDATE_ISSUE_STATUS_FAILURE:   1h21min https://www.youtube.com/watch?v=qis9sMaiqN4&ab_channel=CodeWithZosh
